...
function SupplyDetailPage() {
  ...
  const accessory = getAccessoryByHandle(handle);
  ...
  const relatedAccessories = getAccessoriesByCategory(accessory.category)
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-600">
